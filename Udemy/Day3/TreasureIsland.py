...
first_decision = input("You are at a crossroad. Do you want to go left or right? ").upper()

if first_decision == "LEFT":
    second_decision = input(
        "You come to a lake. There is an island in the middle of the lake. "
        "\n  Do you want to swim or wait for a boat? ").upper()
